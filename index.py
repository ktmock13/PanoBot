...
class Scene:
    def __init__(self, camera, rangeX, rangeY, overlapPercent = 0.333):
        self.camera = camera
...
def main():
  ...
  # Initialize and run
  CAMERA = Camera(CAMERA_FOV, CAMERA_ASPECT)
  scene = Scene(CAMERA, PANO_FOV_X, PANO_FOV_Y, OVERLAP_PERCENT/100)
  scene.printInfo()
  scene.runScene(1000)
