...
menu_items = [
    ...
    {"id": "focusDelay", "value": 300, "increment": 100},
...
def run_menu():
    ...
    GPIO.add_event_detect(16, GPIO.FALLING, callback=up_callback, bouncetime=150)
    GPIO.add_event_detect(20, GPIO.FALLING, callback=select_callback, bouncetime=150)
    GPIO.add_event_detect(21, GPIO.FALLING, callback=down_callback, bouncetime=150)
    try:
        while True:
