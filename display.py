...
class Display:
  ...
  def printMenu(self):
    ...
    self.draw.rectangle((0, 0, self.display.width, self.display.height), outline=0, fill=0)
    # Write four lines of text.
    self.draw.text((0,0), self.menu[3], font=self.font, fill=255)
    self.draw.text((0,8), self.menu[2], font=self.font, fill=255)
    self.draw.text((0,16), self.menu[1], font=self.font, fill=255)
    self.draw.text((0,25), self.menu[0], font=self.font, fill=255)
